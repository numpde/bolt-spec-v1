(function(root, factory) {
  ...
  const DARK_THEME_CSS_OVERRIDES = Object.freeze({
    ...
    "--input-surface": "rgba(41, 49, 54, 0.92)",
    ...
    "--input-invalid-surface": "rgba(65, 46, 29, 0.78)",
